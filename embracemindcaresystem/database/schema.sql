...
-- =========================
-- 2-1. 系統使用者資料
-- 密碼為教學示範用明碼，正式系統應改用雜湊加密
-- =========================
INSERT INTO users(username, password, role, display_name, professional_id, active) VALUES
('admin', 'admin123', 'ADMIN', '系統管理員', NULL, 1),
('doctor', '1234', 'PROFESSIONAL', '醫師共用登入帳號', 1, 1),
('psychologist', '1234', 'PROFESSIONAL', '心理師共用登入帳號', 10, 1),
('doctor1', 'doctor123', 'PROFESSIONAL', '陳志文醫師', 1, 1),
('psychologist1', 'psych123', 'PROFESSIONAL', '李佳蓉臨床心理師', 10, 1),
('user1', 'user123', 'USER', '一般使用者', NULL, 1);
